          ...
          <div className="main"><center>
              <div className="content">
                <div className="login_panel">
                  <h3>লগ ইন /রেজিস্ট্রেশন করুন</h3>
                  <p>Login or Register in with the form below</p>
                  <form action="/Otp" method="get" id="member">
                    <input name="Domain" type="text" defaultValue="" className="field" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'আপনার ফোন নাম্বার লিখুন..';}" />
                    <div className="buttons"><div><button className="grey">OTP পাঠান</button></div></div>
                  </form></div>
                <div className="clear" />
              </div>
            </center></div>
          ...
          <div className="wrapper">	
            <div className="section group">
              ...
              <div className="col_1_of_4 span_1_of_4">
                <h4>একাউন্ট</h4>
                <ul>
                  <li><a href="login.html">লগ ইন</a></li>
